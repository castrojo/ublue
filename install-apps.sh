...
grep -vE '^#' applications.list | xargs sudo flatpak install flathub --assumeyes --noninteractive
grep -vE '^#' applications-beta.list | xargs sudo flatpak install flathub-beta --assumeyes --noninteractive